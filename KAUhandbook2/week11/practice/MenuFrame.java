...
public class MenuFrame extends JFrame 
{
	...
	//no-argument constructor set of GUI
	public MenuFrame() 
	{
		super("Using JMenus");
	...
	private class StyleHandler implements ItemListener
	{
		...
		public void itemStateChanged( ItemEvent e ) 
		{
			...
			if( styleItems[0].isSelected() && styleItems[1].isSelected() ) font = new Font (name, Font.BOLD +Font.ITALIC, 72);
			else if (styleItems[0].isSelected()) font = new Font (name, Font.BOLD , 72);
			else if (styleItems[1].isSelected()) font = new Font (name, Font.ITALIC, 72);
			else font = new Font (name, Font.PLAIN, 72);
